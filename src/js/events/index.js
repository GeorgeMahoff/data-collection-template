...
exports.createEvents = function (options) {
    return {
        ...
        ,'ev-delete-image-success': require('./image/ev-delete-image-success').createEvent(options)
        ...
        ,'ev-upload-image-success': require('./image/ev-upload-image-success').createEvent(options)
        ...
        ,'ev-delete-image': require('./image/ev-delete-image').createEvent(options)
        ...
        ,'ev-upload-image-submit': require('./image/ev-upload-image-submit').createEvent(options)
