...
exports.createEvents = function (options) {
    return {
        ...
        ,'ev-annotation-changed': require('./worker/ev-annotation-changed').createEvent(options)
        ...
        ,'ev-selection-changed': require('./worker/ev-selection-changed').createEvent(options)
        ...
        ,'ev-tap-selection': require('./worker/ev-tap-selection').createEvent(options)
        ,'ev-tap-annotation': require('./worker/ev-tap-annotation').createEvent(options)
