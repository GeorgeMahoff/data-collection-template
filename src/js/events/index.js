...
exports.createEvents = function (options) {
    return {
        ...
        ,'ev-start-campaign-success': require('./campaign/ev-start-campaign-success').createEvent(options)
        ,'ev-stop-campaign-success': require('./campaign/ev-stop-campaign-success').createEvent(options)
        ...
        ,'ev-edit-campaign-submit': require('./campaign/ev-edit-campaign-submit').createEvent(options)
        ...
        ,'ev-start-campaign': require('./campaign/ev-start-campaign').createEvent(options)
        ,'ev-stop-campaign': require('./campaign/ev-stop-campaign').createEvent(options)
        ,'ev-login-success': require('./auth/ev-login-success').createEvent(options)
        ,'ev-campaign-form-submit': require('./campaign/ev-campaign-form-submit').createEvent(options)
        ...
        ,'ev-create-campaign-success': require('./campaign/ev-create-campaign-success').createEvent(options)
    };
};
